...
import {Check, Database, Globe2, Laptop, Mail, Moon, Sun} from "lucide-react";
...
function Connection({icon, name, description, status, active = false}: {icon: ReactNode; name: string; description: string; status: string; active?: boolean}) {
