...
const ADDITIONAL_SERVICE_LANDING_PAGES: ServiceLandingPageConfig[] = [
    {
        ...
        title: "Mobile app development company in India for focused digital products",
        intro: "Adamant helps startups and businesses plan, design, and develop mobile apps with clearer user flows, practical release milestones, and a product experience shaped around real business goals.",
        metaTitle: "Mobile App Development Company in India | Adamant",
        metaDescription: "Adamant is a mobile app development company in India building focused iOS and Android products with clear UX, practical release planning, and scalable foundations.",
        keywords: ["mobile app development company in India", "app development company India", "iOS Android app development"],
    ...
    },
    {
        ...
        keywords: ["website development company Delhi NCR", "web development company Delhi NCR", "website designer Delhi NCR", "Delhi NCR web design"],
        scopeTitle: "What Delhi NCR teams need from a website",
        scopeDescription: "Delhi NCR is a broad market, so the website should connect a clear business proposition with the specific services, audiences, and areas the company genuinely serves.",
        scopeItems: ["Business websites and website redesigns", "Service and location page architecture for NCR demand", "Landing pages for paid and organic campaigns", "Responsive UI with accessible, semantic content", "Technical SEO and analytics readiness", "Ongoing content and conversion improvement"],
        highlights: [
